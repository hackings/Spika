...
var OpenRoomActionHandler = function(){
    
}

_.extend(OpenRoomActionHandler.prototype,SocketHandlerBase.prototype);

OpenRoomActionHandler.prototype.attach = function(io,socket){
...
module["exports"] = new OpenRoomActionHandler();
